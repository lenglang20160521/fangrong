...
public class YuanJingConfig {
    ...
    public  static  final  String brokerHost = "tcp://dev.envisioncn.com:11883";
    //设备名称
    public  static  final String userName = "connect1";
    //设备秘钥
    public  static  final String password = "hSxoKXgUUWe0n97gjTub+teaih5h78mvNHnDNLOAT46VGKrpjNQmG9AuOko=";
